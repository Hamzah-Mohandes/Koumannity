...
export default function ProfileSetup({ onComplete }: ProfileSetupProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // اگر ادمین نبود، محدودیت ۱۵ کاراکتر را اعمال کن
        if (trimmedUser !== 'admin_matrix' && trimmedUser.length > 15) {
            setError('Max 15 characters allowed! | حداکثر ۱۵ کاراکتر مجاز است!');
            return;
        }

        onComplete({ username: trimmedUser, avatar, team });
    };

    return (
        <div className="max-w-md w-full bg-[#1a1a1e]/95 backdrop-blur-md border border-neutral-800 rounded-2xl p-6 md:p-8 shadow-2xl space-y-6">
            <div className="text-center space-y-2">
                <h1 className="text-3xl font-black tracking-wider bg-gradient-to-r from-amber-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
                    INITIALIZE MATRIX
                </h1>
